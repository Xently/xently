...
android {
    namespace = "com.kwanzatukule.features.sales.landing"
...
dependencies {
    ...
    api(project(":features:sales-dashboard"))
    api(project(":features:sales-customer-onboarding"))
    api(project(":features:customer-home"))
    implementation(project(":features:shopping-cart"))
    implementation(project(":features:customer-complaints"))
}