...
suspend fun Throwable.toNotificationTopicError(): Error {
    return when (this) {
        is ResponseException -> toNotificationTopicError()
...
private suspend fun ResponseException.toNotificationTopicError(): Error {
