package co.ke.xently.features.qrcode.presentation.utils

import co.ke.xently.features.qrcode.R
import co.ke.xently.features.qrcode.data.domain.error.DataError
import co.ke.xently.features.qrcode.data.domain.error.Error
import co.ke.xently.features.qrcode.data.domain.error.UnknownError
