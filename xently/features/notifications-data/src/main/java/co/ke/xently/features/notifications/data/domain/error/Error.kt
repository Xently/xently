...
suspend fun Throwable.toNotificationError(): Error {
    return when (this) {
        is ResponseException -> toNotificationError()
...
private suspend fun ResponseException.toNotificationError(): Error {
