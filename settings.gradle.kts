...
include(":xently:libraries:ui-pagination")
include(":xently:libraries:pagination-data")
...
include(":xently:features:openinghours-data")
include(":xently:features:openinghours")
include(":xently:features:storecategory-data")
include(":xently:features:storecategory")
include(":xently:features:storeservice-data")
include(":xently:features:storeservice")
include(":xently:features:productcategory-data")
include(":xently:features:productcategory")
include(":xently:features:reviewcategory-data")
include(":xently:features:reviewcategory")
include(":xently:features:notification-topic-data")
include(":xently:features:notification-topic")
include(":xently:libraries:data-image")
include(":xently:features:access-control")
include(":xently:features:location-picker")
include(":xently:libraries:placeholder")
include(":xently:libraries:placeholder-material3")
