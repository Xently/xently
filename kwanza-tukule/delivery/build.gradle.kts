...
android {
    ...
    defaultConfig {
        applicationId = "com.kwanzatukule.delivery"
...
dependencies {
    ...
    implementation(project(":kwanza-tukule:features:delivery-landing"))
    implementation(project(":kwanza-tukule:features:delivery-route"))
    implementation(project(":kwanza-tukule:features:delivery-dispatch"))
