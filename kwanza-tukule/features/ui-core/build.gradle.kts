...
android {
    namespace = "com.kwanzatukule.features.core"
...
dependencies {
    ...
    api(project(":xently:libraries:data-core"))
    api(project(":xently:libraries:data-auth"))
    api(project(":xently:libraries:ui-core"))
}