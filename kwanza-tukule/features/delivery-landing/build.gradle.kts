...
android {
    namespace = "com.kwanzatukule.features.delivery.landing"
...
dependencies {
    ...
    implementation(project(":kwanza-tukule:features:delivery-home"))
    implementation(project(":kwanza-tukule:features:delivery-profile"))
}